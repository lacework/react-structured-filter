(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react"), require("react-dom"), require("underscore"));
	else if(typeof define === 'function' && define.amd)
		define("react-structured-filter", [, , "underscore"], factory);
	else if(typeof exports === 'object')
		exports["react-structured-filter"] = factory(require("react"), require("react-dom"), require("underscore"));
	else
		root["react-structured-filter"] = factory(root["React"], root["ReactDOM"], root["_"]);
})(window, function(__WEBPACK_EXTERNAL_MODULE__1__, __WEBPACK_EXTERNAL_MODULE__163__, __WEBPACK_EXTERNAL_MODULE__168__) {
...
var StructuredFilter = __webpack_require__(2).Tokenizer;
...
var Typeahead = __webpack_require__(3);
var Tokenizer = __webpack_require__(169);
...
var React = __webpack_require__(1);
var TypeaheadSelector = __webpack_require__(4);
var KeyEvent = __webpack_require__(20);
var fuzzy = __webpack_require__(21);
var DatePicker = __webpack_require__(22);
var moment = __webpack_require__(24);
var cx = __webpack_require__(6);
var onClickOutside = __webpack_require__(167);
...
var Typeahead = onClickOutside(createReactClass({
    ...
    componentWillReceiveProps: function (nextProps) {
        if (!_.isEqual(nextProps.options, this.props.options) || !_.isEqual(nextProps.datatype, this.props.datatype)) {
    ...
    getOptionsForValue: function (value, options) {
        ...
        if (result && result.length == 0 && options && options.length !== 0) {
            this.props.setErrorMsg(this.props.customErrors.noOptionFound || 'Please select or enter valid text for filtering', true);
            return false;
        }
...
//var React = window.React || require('react/addons');
var React = __webpack_require__(1);
var TypeaheadOption = __webpack_require__(5);
var cx = __webpack_require__(6);
var PropTypes = __webpack_require__(7);
var createReactClass = __webpack_require__(14);
/**
...
var TypeaheadSelector = createReactClass({
    ...
    render: function () {
        ...
        if (this.props.errorMsg) {
            showErrorMsg = React.createElement(
                'li',
                { className: 'error' },
                this.props.errorMsg
            );
...
var assign = __webpack_require__(23),
	...
	CalendarContainer = __webpack_require__(160)
	;
...
var React = __webpack_require__(1),
	createClass = __webpack_require__(14),
	DaysView = __webpack_require__(161),
	MonthsView = __webpack_require__(164),
	YearsView = __webpack_require__(165),
	TimeView = __webpack_require__(166)
	;
...
var React = __webpack_require__(1),
	createClass = __webpack_require__(14),
	moment = __webpack_require__(24),
	onClickOutside = __webpack_require__(162).default
	;
...
/* harmony import */ var react_dom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(163);
...
(function(root) {
  ...
  function setupBinding(root, factory) {
    if (true) {
      ...
      !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1),__webpack_require__(163),__webpack_require__(14)], __WEBPACK_AMD_DEFINE_RESULT__ = (function(React, ReactDom, createReactClass) {
    ...
    _addTokenForValue: function (value) {
        ...
        if (isValidEntry.status == true) {
            ...
            setTimeout(function (self) {
                self.setState({ errorMsg: undefined, dropdownError: false });
            }, 3000, this);
        }
        return;
    },
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(Typeahead, { ref: typeahead => this._typeahead = typeahead,
                        className: classList,
                        placeholder: this.props.placeholder,
                        customClasses: this.props.customClasses,
...
var Token = createReactClass({
    ...
    render: function () {
        ...
        return React.createElement(
            'div',
            _extends({}, this.props, { className: 'typeahead-token', title: title }),
...
//# sourceMappingURL=react-structured-filter.js.map